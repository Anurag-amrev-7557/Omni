...
export const ChatInput: React.FC<ChatInputProps> = ({
  ...
  return (
    <div className="w-full select-none relative">
      ...
      {/* Footer Disclaimer & Controls Row (Disclaimer on Left, [Web Search + Model Selector] on Right) */}
      <div className="flex items-center justify-between text-xs text-[var(--text-muted)] mt-2.5 px-1">
        ...
        {/* Right Controls: Web Search (Left of Model) & Model Selector */}
        <div className="flex items-center gap-2 sm:gap-2.5">
          {/* Live Web Research Toggle (Left of Model Toggle) */}
          <button
            type="button"
