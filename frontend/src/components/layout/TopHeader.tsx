  ...
  return (
    <header className="h-14 min-h-[52px] w-full px-6 flex items-center justify-between border-b border-[var(--border-color)] bg-[var(--bg-dark)] select-none">
      ...
      <div className="flex items-center gap-3">
        {sidebarCollapsed && (
          <button 
            className="w-8 h-8 flex items-center justify-center rounded-lg text-[var(--text-muted)] hover:text-[var(--text-main)] hover:bg-[var(--bg-hover)] transition-colors cursor-pointer"
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          ...
          >
            <div className="flex items-center gap-1.5 min-w-0">
              <Palette size={13} className="text-[var(--accent-primary)] flex-shrink-0" />
              <span className="capitalize truncate hidden sm:inline text-[var(--text-main)]">{theme.replace('-dark', '')}</span>
            </div>
            <ChevronDown size={12} className="flex-shrink-0 text-[var(--text-muted)] group-hover:text-[var(--text-main)] transition-colors" />
          </button>
        ...
        >
          <Settings size={15} className="text-[var(--text-main)] group-hover:rotate-45 transition-transform duration-300" />
        </button>
      </div>
    </header>
  );
