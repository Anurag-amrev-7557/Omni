                ...
                >
                  ...
                  <td className="py-3.5 px-5 text-right" onClick={(e) => e.stopPropagation()}>
                    <div className="flex items-center justify-end gap-1">
                      ...
                      {onEnhance && (
                        <button
                          className="p-1.5 rounded-lg text-[var(--text-muted)] hover:text-violet-400 hover:bg-violet-500/10 transition-colors cursor-pointer"
                          onClick={() => onEnhance(doc.filename)}
                          title="Enhance: run AI summary + knowledge graph extraction"
                        >
                          <Sparkles size={14} />
                        </button>
                      )}
